            ...
            <div className='p-10 lg-pt-48 container mx-auto relative'>
                <section className="bg-gray-600 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className='text-lg flex flex-col justify-center'>
                        <h1 className="cursive text-7xl text-gray-200 mb-4">Sean Brasse</h1>
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent blocks={author.bio} projectId ="s0jrn46i" dataset="production" />
                        </div>
                        <div className='grid justify-items-auto p1'>
                            <h1 className='text-4xl text-center mt-12 font-bold cursive'> Scroll for more about me!</h1>
                        </div>    
                    </div>
                </section>
            </div>
