  ...
  return (
    <main className="bg-gray-100 min-h-screen">
      ...
      <section className="container mx-auto relative min-h-screen">
        ...
        <h2 className="text-lg text-black flex justify-center text-1xl pt-4 mb-12">
          ...
          {projectData &&
            projectData.map((project, index) => (
              <article>
                ...
                >
                  <span
                    className="block h-64 relative rounded-lg shadow-xl leading-snug bg-white border-1 border-l-8 border-gray-600"
                    key={index}
                  >
                    <img
                    ...
                    <span className="block relative h-full flex justify-end items-end pr-2 pb-2">
                      <h4 className="text-gray-900 bg-gray-300 bg-opacity-75 p-1 rounded text-3xl hover:bg-blue-300">
                        {project.title}
                      </h4>
